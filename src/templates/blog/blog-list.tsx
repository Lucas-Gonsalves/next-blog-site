    ...
    <div className=" flex flex-col py-24 grow h-full">
      ...
      { !hasPosts && (
        <div className="container px-32">
          <div className="container flex flex-col items-center justify-center gap-8 border-dashed border-2 border-gray-300 p-8 md:p-12 rounded-lg">
            <Inbox className="h-12 w-12 text-cyan-100"/>
            <span className="text-gray-300 text-center text-body-md">Nenhum post encontrado.</span>
          </div>
        </div>
      )}
